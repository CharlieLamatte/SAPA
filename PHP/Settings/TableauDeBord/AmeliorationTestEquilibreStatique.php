...
if (!empty($input_data->id_territoire)) {
    ...
    $stats_all = $s->getAmeliorationTestEquilibreStatique(
        $input_data->id_territoire,
        $input_data->year,
        $input_data->id_structure,
        "-1"
    );
    $stats_hommes = $s->getAmeliorationTestEquilibreStatique(
        $input_data->id_territoire,
        $input_data->year,
        $input_data->id_structure,
        "M"
    );
    $stats_femmes = $s->getAmeliorationTestEquilibreStatique(
        $input_data->id_territoire,
        $input_data->year,
        $input_data->id_structure,
        "F"
