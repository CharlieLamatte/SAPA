...
<!-- Page pour l'ajout d'un questionnaire ONAPS -->
<!DOCTYPE html>
<html lang="fr">
...
<head>
    ...
    <title>Ajout Questionnaire</title>
...
require '../header.php'; ?>
<div class="container">
    <form id="questionnaire" data-id_questionnaire="<?php
    echo $id_questionnaire; ?>" data-id_user="<?php
...
<script type="text/javascript" src="../../js/questionnaireONAPS.js"></script>
</body>
</html>