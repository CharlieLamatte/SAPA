...
$id_evaluation = $evaluation->create([
    ...
    'fcmax' => $_POST['fcmax'],
    'motif_test_physio' => $_POST['motif_test_physio'],
    ...
    'borg9' => $_POST['borg9'],
    'com_aa' => $_POST['com_aa'],
    'motif_apt_aerobie' => $_POST['motif_apt_aerobie'],
    ...
    'pg' => $_POST['pg'],
    'pd' => $_POST['pd'],
    'motif_eq_stat' => $_POST['motif_eq_stat'],
    ...
    'mgh' => $_POST['mgh'],
    'mdh' => $_POST['mdh'],
    'motif_mobilite_scapulo_humerale' => $_POST['motif_mobilite_scapulo_humerale'],
    ...
    'sat30' => $_POST['sat30'],
    'borg30' => $_POST['borg30'],
    'motif_end_musc_mb_inf' => $_POST['motif_end_musc_mb_inf']
]);
...
if ($id_evaluation) {
    ...
    //on retire la date d'évaluation suivante du bénéficiaire
    $patient = new Patient($bdd);
    $update_eval_suiv = $patient->updateDateEvalSuiv($_GET['idPatient'], null);

    //variable pour savoir si le retour à la page des évaluations fait suite à l'ajout d'une évaluation
    //true = nouvelle évaluation non-finale, false = nouvelle évaluation finale
    if ($_POST['eval_etat'] == "14") {
        $_SESSION['new_eval_non_finale'] = false;
    } else {
        $_SESSION['new_eval_non_finale'] = true;
    }
    ...
    \Sportsante86\Sapa\Outils\SapaLogger::get()->critical(
        'An unexpected error occurred when user ' . $_SESSION['email_connecte'] . ':' . $_SESSION['id_user'] . ' attempted to create an evaluation',
        [
