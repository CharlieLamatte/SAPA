 ...
 *       &lt;sequence>
 *         &lt;element name="NumIdentifiant" type="{http://www.cnamts.fr/INSiResultat}NIR"/>
 *         &lt;element name="Cle" type="{http://www.cnamts.fr/INSiResultat}CLE" minOccurs="0"/>
...
public class Matricule {
    ...
    @XmlElement(name = "NumIdentifiant", required = true)
