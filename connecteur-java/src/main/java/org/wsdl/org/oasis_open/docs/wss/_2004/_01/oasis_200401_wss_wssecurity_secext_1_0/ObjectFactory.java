...
public class ObjectFactory {
    ...
    /**
     * Create an instance of {@link TypeSecurity }
     * 
     */
    public TypeSecurity createTypeSecurity() {
        return new TypeSecurity();
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TypeSecurity }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd", name = "Security")
    public JAXBElement<TypeSecurity> createSecurity(TypeSecurity value) {
        return new JAXBElement<TypeSecurity>(_Security_QNAME, TypeSecurity.class, null, value);
    }
