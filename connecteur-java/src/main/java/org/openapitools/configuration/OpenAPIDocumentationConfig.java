...
public class OpenAPIDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            ...
            .description("Cet API REST est un connecteur entre le client SOAP INS et le logiciel SAPA")
            .license("")
    ...
    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.connecteurINSSAPA.base-path:/v1}") String basePath) {
