...
class SantePoidsCest  // /!\ Cest est obligatoire après le nom de la classe
{
    
    public function PoidsNormal(AcceptanceTester $I)
    {
        //Test avec les parametres valide
        //Cas 1 : Ok 
        //On met le poids : 85 kg + formulaire avec données cohérente 
    ...
    public function PoidsPetit(AcceptanceTester $I)
    {
        //Test avec les parametres invalide
        //Cas 2 : Erreur 
        //On met le poids : 18kg + formulaire avec données cohérente
    ...
    public function PoidsTropGrand(AcceptanceTester $I)
    {
        //Test avec les parametres invalide
        //Cas 3 : Erreur
        //On met le poids : 350kg + formulaire avec données cohérente
        //Données non enregistré
    ...
    public function PoidsNegatif(AcceptanceTester $I)
    {
        //Test avec les parametres invalide
        //Cas 4 : Erreur
        //On met le poids : -75kg + formulaire avec données cohérente
        //Données non enregistré
    ...
    public function PoidsUneDecimal(AcceptanceTester $I)
    {
        //Test avec les parametres valide
        //Cas 5 : Ok
        //On met le poids : 70.3kg + formulaire avec données cohérente
        //Enregistrement des données done
    ...
    public function PoidsDeuxDecimal(AcceptanceTester $I)
    {
        //Test avec les parametres invalide
        //Cas 6 : Erreur
        //On met le poids : 50.23kg + formulaire avec données cohérente
        //Données non enregistré
    ...
    public function PoidsLettre(AcceptanceTester $I)
    {
        //Test avec les parametres invalide
        //Cas 7 : Erreur
        //On met le poids : PZ/ + formulaire avec données cohérente
        //Données non enregistré
    ...
    public function PoidsVide(AcceptanceTester $I)
    {
        //Test avec les parametres invalide
        //Cas 8 : Erreur
        //On ne met rien pour le poids + formulaire avec données cohérente
        //Données non enregistré
