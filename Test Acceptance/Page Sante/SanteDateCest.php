...
class SanteDateCest // /!\ Cest est obligatoire après le nom de la classe
{


public function DateValide(AcceptanceTester $I)
    {
        //Test avec les parametres valide
        //Cas 90 : Ok 
        //On met la date FC max mesuree : 17/06/2020 + formulaire avec données cohérente 
    ...
    public function DateAvecLettre(AcceptanceTester $I)
    {
        ...
        // Je rempli le champ "DATE" avec la valeur "PPMRDTP"
        $I->fillField('date_imc', 'PPMRDTP');
    ...
    public function DateAvecAnneeNegative(AcceptanceTester $I)
    {
        ...
        // Je rempli le champ "DATE" avec la valeur "16/08/-600"
        $I->fillField('date_imc', '16/08/-600');
    ...
    public function DateAvecAnneeDansLeFutur(AcceptanceTester $I)
    {
        //Test avec les parametres invalide
        //Cas 93 : Erreur
        ...
        // Je rempli le champ "DATE" avec la valeur "13/03/2200"
        $I->fillField('date_imc', '13/03/2200');
        ...
        // Je rempli le champ "date FC max mesurée" (champ du date FC max mesurée) avec la valeur "16/03/2020"
        $I->fillField('Date_FC_max_mesuree', '16/03/2020');
    ...
    public function DateAbsente(AcceptanceTester $I)
    {
        ...
        // Je rempli le champ "DATE" avec la valeur ""
        $I->fillField('date_imc', '');
