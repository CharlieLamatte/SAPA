<?php
//***
//Ce test permet de vérifier si la page de setting est bien accessible, depuis la page d'accueil du site, 
//en passant pas le bouton réglage et arrivant sur la page de paramètre. 
//Sur cette page, l'on peut voir qu'il y a écrit : Paramètres supplémentaires. 
//Ce test permet donc de vérifier que nous allons bien sur cette page web. 
//Ces tests concernent la page Settings.php
//***
...
class SettingCest  // /!\ Cest est obligatoire après le nom de la classe
{
    ...
    //Test qui vérifie que nous pouvons aller sur la page paramètre afin de visualiser les différentes informations nécessaire. 
	//Et retourner à la page Accueil_liste.php
	//Ce test ne doit pas provoquer d'erreurs
    public function AllezSurPageSettingCorrect(AcceptanceTester $I)
    {
