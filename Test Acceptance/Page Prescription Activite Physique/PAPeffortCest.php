...
class PAPeffortCest  // /!\ Cest est obligatoire après le nom de la classe
{
     //EFFORT
    public function cas17(AcceptanceTester $I)
    {
        //Test avec les parametres valide
        //cas 17 : OK 
        //On coche une seule case dans la catégorie Effort a ne pas réaliser + formulaire remplie avec des valeur cohérente( cocher au moins une case partout et remplir les champs de saisie correctement )
    ...
    public function cas18(AcceptanceTester $I)
    {
        //Test avec les parametres valide
        //cas 18 : OK 
        //On coche toute les cases de la catégorie Effort a ne pas réaliser + remplir le formulaire correctement ( cocher au moins une case partout et remplir les champs de saisie correctement )
        //Affichage message de succès 
        ...
        //Je test avec toutes les options du champ "Efforts à ne pas réaliser" est coché, ici : Endurance
        $I->seeCheckBoxIsChecked('Endurance');
        $I->seeCheckBoxIsChecked('Vitesse');
        $I->seeCheckBoxIsChecked('Résistance');
    ...
    public function cas19(AcceptanceTester $I)
    {
        //Test avec les parametres valide
        //cas 19 : Erreur
        //On ne coche aucune case de la catégorie Effort a ne pas réaliser + remplir le formulaire correctement ( cocher au moins une case partout et remplir les champs de saisie correctement )
        ...
        //Je test avec aucune options du champ "Efforts à ne pas réaliser" est coché, ici : Endurance
