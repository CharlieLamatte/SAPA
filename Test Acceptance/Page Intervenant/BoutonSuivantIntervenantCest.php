<?php
//Dans ce fichier, nous testons la page des intervenants et notamment les boutons pour se déplacer sur les differentes pages regroupant les intervenants
...
class BoutonSuivantIntervenantCest  // /!\ Cest est obligatoire après le nom de la classe
{
	
    
    public function Cas8_boutonAjoutIntervenant(AcceptanceTester $I)
	//ce test est correct
...
public function Cas9_boutonPrecedentIntervenant(AcceptanceTester $I)
	//ce test est correct
	...
	public function Cas10_boutonNumPageIntervenant(AcceptanceTester $I)
	//ce test est correct
	//lorsqu'on clique sur un de ces boutons, on est rediriger vers la page souhaitée
    {
		...
		//Test du bouton numero de page, 6
		//vérification de la présence du bouton
        $I->seeElement('//*[@id="table_id_paginate"]/span/a[6]');
		
		//verification si le bouton est cliquable
		$I->click('//*[@id="table_id_paginate"]/span/a[6]');
		
		//verification de la redirection vers la page d'avant
		$I->wait(2);
		$I->seeInCurrentUrl('/PHP/Intervenants/ListeIntervenant.php');
		
		//Test du bouton numero de page, 7
		//vérification de la présence du bouton
        $I->seeElement('//*[@id="table_id_paginate"]/span/a[7]');
		
		//verification si le bouton est cliquable
		$I->click('//*[@id="table_id_paginate"]/span/a[7]');
