...
class Ajouteintervenant_statutCest  // /!\ Cest est obligatoire après le nom de la classe
{
	
    
    public function Cas1_vide(AcceptanceTester $I)
	//ce test est correct
	//lorsqu'on clique sur ce bouton, on est rediriger vers la page AjoutIntervenant.php
    {
     ...
     $webdriver->switchTo()->window($last_window);
		...
		public function Cas2_Bénévole(AcceptanceTester $I)
    //ce test est correct
    //lorsqu'on clique sur ce bouton, on est rediriger vers la page AjoutIntervenant.php
    {
        $I->amOnPage('index.php');
     ...
     $webdriver->switchTo()->window($last_window);
        ...
        $I-> fillField('tel','0606060606');
        $I->selectOption('diplome', 'DEJEPS');
        $I->selectOption('statut', 'Bénévole');
        $I-> fillField('numero_carte','0123456789');
        ...
        public function Cas3_Salarié(AcceptanceTester $I)
    //ce test est correct
    //lorsqu'on clique sur ce bouton, on est rediriger vers la page AjoutIntervenant.php
    {
        $I->amOnPage('index.php');
    ...
    public function Cas4_Libéral(AcceptanceTester $I)
    //ce test est correct
    //lorsqu'on clique sur ce bouton, on est rediriger vers la page AjoutIntervenant.php
    {
        $I->amOnPage('index.php');
