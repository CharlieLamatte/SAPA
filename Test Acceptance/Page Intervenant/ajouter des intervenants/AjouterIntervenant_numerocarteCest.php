...
class Ajouteintervenant_numerocarteCest  // /!\ Cest est obligatoire après le nom de la classe
{
	...
	//lorsqu'on clique sur ce bouton, on est rediriger vers la page AjoutIntervenant.php
    {
     ...
     $webdriver->switchTo()->window($last_window);
        ...
        $I-> fillField('numero_carte','06 12 34 56 78');
    ...
    //lorsqu'on clique sur ce bouton, on est rediriger vers la page AjoutIntervenant.php
    {
     ...
     $webdriver->switchTo()->window($last_window);
        ...
        $I->selectOption('diplome', 'DEJEPS');
        $I->selectOption('statut', 'Salarié');
        $I-> fillField('numero_carte','0612345678');
    ...
    //lorsqu'on clique sur ce bouton, on est rediriger vers la page AjoutIntervenant.php
    {
     ...
     $webdriver->switchTo()->window($last_window);
        ...
        $I->selectOption('diplome', 'DEJEPS');
        $I->selectOption('statut', 'Salarié');
        $I-> fillField('numero_carte','azertyuiop');
    ...
    //lorsqu'on clique sur ce bouton, on est rediriger vers la page AjoutIntervenant.php
    {
     ...
     $webdriver->switchTo()->window($last_window);
        ...
        $I->selectOption('diplome', 'DEJEPS');
        $I->selectOption('statut', 'Salarié');
        $I-> fillField('numero_carte','éééééééééé');
    ...
    //lorsqu'on clique sur ce bouton, on est rediriger vers la page AjoutIntervenant.php
    {
     ...
     $webdriver->switchTo()->window($last_window);
        ...
        $I->selectOption('diplome', 'DEJEPS');
        $I->selectOption('statut', 'Salarié');
        $I-> fillField('numero_carte','12345678912');
