...
class GestionIntervenant_TriCest  // /!\ Cest est obligatoire après le nom de la classe
{
    // ce document contient les tests en rapport avec le tri par ordre alphabétique et inversement.

    public function Cas12_TriNomAlphabetique(AcceptanceTester $I)
    ...
    public function Cas_TriPrenomAlphabetique(AcceptanceTester $I)
    //Verification du tri des prénoms en ordre alphabétique/ReverseAlphabetique
        ...
        $I->see('Abdelhamid','//*[@id="table_id"]/tbody');
        }

    public function Cas_TriMailAlphabetique(AcceptanceTester $I)
    ...
    public function Cas_TriTelephoneAlphabetique(AcceptanceTester $I)
    //Verification du tri des telephone en ordre alphabétique/ReverseAlphabetique
        ...
        $I->see('067388291','//*[@id="table_id"]/tbody');
        }
}