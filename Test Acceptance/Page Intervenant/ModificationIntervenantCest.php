<?php
//Dans ce fichier, nous testons la page des intervenants et notamment le bouton modifier qui permet la modification d'information d'un intervenant
...
class ModificationIntervenantCest  // /!\ Cest est obligatoire après le nom de la classe
{
	
    
    public function Cas7_modificationIntervenant(AcceptanceTester $I)
	//ce test est correct
	//lorsqu'on clique sur ce bouton, on est rediriger vers la page ModifIntervenant.php
    {
     ...
     $webdriver->switchTo()->window($last_window);
		...
		$I->wait(2);
		$I->seeInCurrentUrl('/PHP/Intervenants/ModifIntervenant.php');
